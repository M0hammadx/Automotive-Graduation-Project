...
*/
    printf("now in Com Trigger Transmit\n");
...
void Com_RxIndication(PduIdType PduHandleId, const PduInfoType *PduInfoPtr){
    ...
    printf("router CANIF reception indication has finished\n");

}

void Com_TxConfirmation(PduIdType PduHandleId, Std_ReturnType result){
    printf("now in Com TX confirmation\n");
    printf("router CANIF confirmation has finished\n");
}
