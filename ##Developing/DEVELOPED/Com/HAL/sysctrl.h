...
#define CAN0_INT_NUMBER    39
#define CAN1_INT_NUMBER    40
...
typedef enum{
	GPIOA , GPIOB , GPIOC , GPIOD , GPIOE , GPIOF , CAN_0,CAN_1,UART_0,UART_1 , UART_2 , UART_3 ,UART_4 ,UART_5 , UART_6 ,UART_7
}sSysCtrlModules_t;
