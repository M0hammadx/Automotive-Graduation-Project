...
#define CANIF_INF_RX_PDU_0_CAN_ID   3
#define CANIF_INF_RX_PDU_1_CAN_ID   2
#define CANIF_INF_TX_PDU_0_CAN_ID   8

/* -------------------------------------------------------------------------- */
/*                       Structures and Enumerations                          */
/* -------------------------------------------------------------------------- */
typedef enum {
    CANIF_INF_RX_PDU_0=0,   ///CanIf - distance
    CANIF_INF_RX_PDU_1=1,   ///CanIf - RPM
    CANIF_INF_RX_CNT  =2
}CanIf_INF_Rx_Pdus;
