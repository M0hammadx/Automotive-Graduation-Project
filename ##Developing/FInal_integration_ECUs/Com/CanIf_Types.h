...
typedef enum{
    EXTENDED_2,       ///All the CANIDs are of type extended only (29 bit).
    STANDARD_2        ///All the CANIDs are of type standard only (11bit).
...
*/
#if (CANIF_INF_RUNTIME_PDU_CONFIGURATION == STD_OFF)
    const CanHardwareObject *CanIfHrhIdSymRef;         ///CanHardwareObjectType
#else
...
*/
    const CanHardwareObject *CanIfHthIdSymRef;           ///CanHardwareObject
